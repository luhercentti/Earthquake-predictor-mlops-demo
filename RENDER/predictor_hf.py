...
def _resolve_region(country, city, lat, lon, radius_km, parquet_path=None):
    if country:
...
def run_forecast(
    ...
    region_name, lat_range, lon_range = _resolve_region(country, city, lat, lon, radius_km, parquet_path)
